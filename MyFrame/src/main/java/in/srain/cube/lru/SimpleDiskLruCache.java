...
public final class SimpleDiskLruCache implements DiskCache {
    ...
    private in.srain.cube.diskcache.lru.LruActionTracer mActionTracer;
    ...
    public SimpleDiskLruCache(File directory, int appVersion, long capacity) {
        ...
        mActionTracer = new in.srain.cube.diskcache.lru.LruActionTracer(this, directory, appVersion, capacity);
        if (DEBUG) {
