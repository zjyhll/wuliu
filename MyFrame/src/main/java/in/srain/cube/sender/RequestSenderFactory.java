...
import in.srain.cube.request.sender.*;
...
public class RequestSenderFactory {
    ...
    public static <T> in.srain.cube.request.sender.BaseRequestSender create(IRequest<T> request) {
        in.srain.cube.request.sender.BaseRequestSender sender = null;
        try {
