package in.srain.cube.indicator;

import in.srain.cube.views.ptr.indicator.*;

public class PtrTensionIndicator extends in.srain.cube.views.ptr.indicator.PtrIndicator {
