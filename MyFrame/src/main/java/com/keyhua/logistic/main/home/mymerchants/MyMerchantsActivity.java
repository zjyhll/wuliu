...
public class MyMerchantsActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    // 上拉下拉刷新
    LoadMoreListViewContainer loadMoreListViewContainer = null;
    private ListView lv_home = null;
    private MerchantsListAdpter listadapter = null;
    ...
    protected void onInitData() {
        ...
        try {
            obj.put("name", "成都多钱科技");
            obj.put("time", "推荐时间 2015-12-10");
            obj.put("num", "20");
            arr.put(obj);
            obj = new JSONObject();
            obj.put("name", "成都科技公司");
            obj.put("time", "推荐时间 2016-1-10");
            obj.put("num", "2");
            arr.put(obj);
        ...
        listadapter = new MerchantsListAdpter(this, arr);
    ...
    private void refreshAndLoadMore() {
        ...
        loadMoreListViewContainer.setLoadMoreHandler(new LoadMoreHandler() {
            ...
            public void onLoadMore(LoadMoreContainer loadMoreContainer) {
                if (NetUtil.isNetworkAvailable(MyMerchantsActivity.this)) {// 有网
